...
public class ChoosingWorkgroup1 extends AppCompatActivity implements View.OnClickListener{
        ...
        call.enqueue(new Callback<WorkGroupsResponse>() {
            ...
            public void onResponse(Call<WorkGroupsResponse> call, Response<WorkGroupsResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    Toast.makeText(ChoosingWorkgroup1.this, "connection done", Toast.LENGTH_SHORT).show();
                    res = response.body();
                    updateLayout();
                } else {
                    Toast.makeText(ChoosingWorkgroup1.this, "Failed to fetch Info", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<WorkGroupsResponse> call, Throwable t) {
                Toast.makeText(ChoosingWorkgroup1.this, t.toString(), Toast.LENGTH_SHORT).show();
            }
    ...
    void updateLayout(){
        if(res.getResult().contains("Doctor"))
            itemList.add(new Item("Doctor",R.drawable.design_img)) ;
    ...
    public void onClick(View view) {
        ...
        if(view.getId()==R.id.next_b){
            ...
            Intent i=new Intent(ChoosingWorkgroup1.this, Home.class);
            startActivity(i);
    ...
    public void onItemClick(int position) {
        ...
        Intent i=new Intent(ChoosingWorkgroup1.this, SellerList_SingleWorkGroup.class);
        startActivity(i);
    }
}